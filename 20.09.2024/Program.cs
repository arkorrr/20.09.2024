...
class Program
{
    static void Main(string[] args)
    {
        ...
        cafe.Arrive(new Visitor("Алексей", false));
        cafe.Arrive(new Visitor("Мария", true));
        cafe.Arrive(new Visitor("Иван", false));
        cafe.Arrive(new Visitor("Ольга", false));
        cafe.Arrive(new Visitor("Дмитрий", false));
